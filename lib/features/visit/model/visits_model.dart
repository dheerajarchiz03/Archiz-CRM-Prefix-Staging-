class VisitsModel {
  ...
  VisitsModel.fromJson(dynamic json) {
    _status = json['status'];
...
class Visit {
  ...
  Visit.fromJson(dynamic json) {
    ...
    if (json['timelines'] != null) {
      ...
      json['timelines'].forEach((v) {
        _timelines?.add(Timeline.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_timelines != null) {
      map['timelines'] = _timelines?.map((v) => v.toJson()).toList();
    }
